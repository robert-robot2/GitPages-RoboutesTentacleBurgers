...
namespace SpectralXGLX.SpectralXComponent
{
    public partial class SpectralXEngine
    {
        public void InitScene10()
        {
            ...
            Weather.Init(Scene10, MeshLibrary, new Dictionary<WeatherParticleType, ParticleVolume>
    {
        ...
        "/iAssets/IceTile010.png",
            ...
            // ── BWPScene7 (Forest 6) ─────────────────────────────────────────────
            AddSignpost(Scene10, "Scene10_SignpostToForest5",
                GetTriggerPos(SceneID.BWPScene7, SceneID.BWPScene6));
            AddSignpost(Scene10, "Scene10_SignpostToDarkForest1",
                GetTriggerPos(SceneID.BWPScene7, SceneID.BWPScene8));
            ...
            SpectralDynManager.SpawnAll(Scene10, MeshLibrary, spawnRadius: 60f, seed: 42);
            ...
            WaveSystem.RegisterSceneWaves(SceneID.BWPScene7, new WaveDefinition[]
         {
    // Wave 1
    new WaveDefinition { Skeletons = new[]{1}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{2}, Goatman = new[]{1}, SkeletonWar = new[]{2}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0}, OnWaveStart = () => Console.WriteLine("[Scene10] Wave 1 started!") },
    // Wave 2
    new WaveDefinition { Skeletons = new[]{1}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{2}, Goatman = new[]{2}, SkeletonWar = new[]{2}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 3
    ...
    // Wave 4
    new WaveDefinition { Skeletons = new[]{2}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{3}, Goatman = new[]{3}, SkeletonWar = new[]{3}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 5
    new WaveDefinition { Skeletons = new[]{1}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{4}, Goatman = new[]{3}, SkeletonWar = new[]{4}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 6
    new WaveDefinition { Skeletons = new[]{1}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{4}, Goatman = new[]{4}, SkeletonWar = new[]{4}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 7
    new WaveDefinition { Skeletons = new[]{0}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{5}, Goatman = new[]{4}, SkeletonWar = new[]{5}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 8
    new WaveDefinition { Skeletons = new[]{0}, PsychoSkeletons = new[]{1}, ZombiePsycho = new[]{5}, Goatman = new[]{5}, SkeletonWar = new[]{5}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 9
    new WaveDefinition { Skeletons = new[]{0}, PsychoSkeletons = new[]{1}, ZombiePsycho = new[]{5}, Goatman = new[]{5}, SkeletonWar = new[]{6}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 10
