...
namespace SpectralXGLX.SpectralXComponent
{
    public partial class SpectralXEngine
    {
        public void InitScene7()
        {
            ...
            Weather.Init(Scene7, MeshLibrary, new Dictionary<WeatherParticleType, ParticleVolume>
    {
        ...
        "/iAssets/IceTile010.png",
            ...
            // ── BWPScene4 (Forest 3) ─────────────────────────────────────────────
            AddSignpost(Scene7, "Scene7_SignpostToForest2",
                GetTriggerPos(SceneID.BWPScene4, SceneID.BWPScene3));
            AddSignpost(Scene7, "Scene7_SignpostToForest4",
                GetTriggerPos(SceneID.BWPScene4, SceneID.BWPScene5));
            ...
            SpectralDynManager.SpawnAll(Scene7, MeshLibrary, spawnRadius: 60f, seed: 42);
            ...
            WaveSystem.RegisterSceneWaves(SceneID.BWPScene4, new WaveDefinition[]
        {
    // Wave 1
    new WaveDefinition { Skeletons = new[]{3}, PsychoSkeletons = new[]{1}, ZombiePsycho = new[]{0}, Goatman = new[]{0}, SkeletonWar = new[]{0}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0}, OnWaveStart = () => Console.WriteLine("[Scene7] Wave 1 started!") },
    // Wave 2
    new WaveDefinition { Skeletons = new[]{3}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{1}, Goatman = new[]{0}, SkeletonWar = new[]{0}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 3
    new WaveDefinition { Skeletons = new[]{4}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{1}, Goatman = new[]{0}, SkeletonWar = new[]{1}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 4
    new WaveDefinition { Skeletons = new[]{4}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{2}, Goatman = new[]{0}, SkeletonWar = new[]{1}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 5
    ...
    // Wave 6
    new WaveDefinition { Skeletons = new[]{3}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{3}, Goatman = new[]{0}, SkeletonWar = new[]{2}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 7
    new WaveDefinition { Skeletons = new[]{2}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{3}, Goatman = new[]{0}, SkeletonWar = new[]{3}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 8
    new WaveDefinition { Skeletons = new[]{2}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{3}, Goatman = new[]{0}, SkeletonWar = new[]{3}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 9
    new WaveDefinition { Skeletons = new[]{1}, PsychoSkeletons = new[]{1}, ZombiePsycho = new[]{4}, Goatman = new[]{0}, SkeletonWar = new[]{4}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 10
    new WaveDefinition { Skeletons = new[]{1}, PsychoSkeletons = new[]{1}, ZombiePsycho = new[]{4}, Goatman = new[]{0}, SkeletonWar = new[]{4}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
        });

            WaveSystem.SetScene(SceneID.BWPScene4);
            WaveSystem.LoadWave(1);

         

            Console.WriteLine("[SpectralXEngine] Skeleton spawned from menu");
            Console.WriteLine("[InitScene7] Scene7 ready");
        }
