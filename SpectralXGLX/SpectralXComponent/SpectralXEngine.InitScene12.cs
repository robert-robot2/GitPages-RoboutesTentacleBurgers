...
namespace SpectralXGLX.SpectralXComponent
{
    public partial class SpectralXEngine
    {
        public void InitScene12()
        {
            ...
            Weather.Init(Scene12, MeshLibrary, new Dictionary<WeatherParticleType, ParticleVolume>
    {
        ...
        "/iAssets/IceTile010.png",
            ...
            // ── BWPScene9 (Graveyard) ────────────────────────────────────────────
            AddSignpost(Scene12, "Scene12_SignpostToDarkForest",
                GetTriggerPos(SceneID.BWPScene9, SceneID.BWPScene8));

            StaticProps = new SpectralProps();
            StaticProps.SpawnScattered(
                MeshLibrary, Scene12,
                SpectralPropDefs.GYDictionary(),
                SpectralPropDefs.All,
                spawnRadius: 64f, clearRadius: 3f, seed: 42);

            SpectralDynManager.SpawnAll(Scene12, MeshLibrary, spawnRadius: 60f, seed: 42);
            ...
            WaveSystem.RegisterSceneWaves(SceneID.BWPScene9, new WaveDefinition[]
          {
    // Wave 1
    new WaveDefinition { Skeletons = new[]{4}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{3}, Goatman = new[]{0}, SkeletonWar = new[]{2}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0}, OnWaveStart = () => Console.WriteLine("[Scene12] Wave 1 started!") },
    // Wave 2
    new WaveDefinition { Skeletons = new[]{5}, PsychoSkeletons = new[]{4}, ZombiePsycho = new[]{4}, Goatman = new[]{0}, SkeletonWar = new[]{3}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 3
    new WaveDefinition { Skeletons = new[]{5}, PsychoSkeletons = new[]{4}, ZombiePsycho = new[]{5}, Goatman = new[]{0}, SkeletonWar = new[]{4}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 4
    new WaveDefinition { Skeletons = new[]{6}, PsychoSkeletons = new[]{5}, ZombiePsycho = new[]{5}, Goatman = new[]{0}, SkeletonWar = new[]{4}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 5
    new WaveDefinition { Skeletons = new[]{6}, PsychoSkeletons = new[]{5}, ZombiePsycho = new[]{6}, Goatman = new[]{0}, SkeletonWar = new[]{5}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 6
    new WaveDefinition { Skeletons = new[]{5}, PsychoSkeletons = new[]{5}, ZombiePsycho = new[]{6}, Goatman = new[]{0}, SkeletonWar = new[]{5}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 7
    new WaveDefinition { Skeletons = new[]{4}, PsychoSkeletons = new[]{4}, ZombiePsycho = new[]{7}, Goatman = new[]{0}, SkeletonWar = new[]{6}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 8
    new WaveDefinition { Skeletons = new[]{3}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{7}, Goatman = new[]{0}, SkeletonWar = new[]{6}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 9
    new WaveDefinition { Skeletons = new[]{2}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{8}, Goatman = new[]{0}, SkeletonWar = new[]{7}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 10 — Skeleton Boss final wave
    new WaveDefinition { Skeletons = new[]{0}, PsychoSkeletons = new[]{0}, ZombiePsycho = new[]{0}, Goatman = new[]{0}, SkeletonWar = new[]{0}, ScavBoss = new[]{0}, SkeletonBoss = new[]{1}, OnWaveStart = () => Console.WriteLine("[Scene12] Wave 10 — Skeleton Boss!") },
          });
            WaveSystem.SetScene(SceneID.BWPScene9);
            WaveSystem.LoadWave(1);

      

            Console.WriteLine("[SpectralXEngine] Skeleton spawned from menu");
            Console.WriteLine("[InitScene12] Scene12 ready");
        }
