...
namespace SpectralXGLX.SpectralXComponent
{
    public partial class SpectralXEngine
    {
        public void InitScene8()
        {
            ...
            Weather.Init(Scene8, MeshLibrary, new Dictionary<WeatherParticleType, ParticleVolume>
    {
        ...
        "/iAssets/IceTile010.png",
            ...
            // ── Signpost ─────────────────────────────────────────
            // ── BWPScene5 (Forest 4) ─────────────────────────────────────────────
            AddSignpost(Scene8, "Scene8_SignpostToForest3",
                GetTriggerPos(SceneID.BWPScene5, SceneID.BWPScene4));
            AddSignpost(Scene8, "Scene8_SignpostToForest5",
                GetTriggerPos(SceneID.BWPScene5, SceneID.BWPScene6));
            ...
            SpectralDynManager.SpawnAll(Scene8, MeshLibrary, spawnRadius: 60f, seed: 42);
            ...
            WaveSystem.RegisterSceneWaves(SceneID.BWPScene5, new WaveDefinition[]
      {
    // Wave 1
    new WaveDefinition { Skeletons = new[]{2}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{1}, Goatman = new[]{0}, SkeletonWar = new[]{1}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0}, OnWaveStart = () => Console.WriteLine("[Scene8] Wave 1 started!") },
    // Wave 2
    new WaveDefinition { Skeletons = new[]{3}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{1}, Goatman = new[]{0}, SkeletonWar = new[]{1}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 3
    new WaveDefinition { Skeletons = new[]{3}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{2}, Goatman = new[]{0}, SkeletonWar = new[]{2}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 4
    new WaveDefinition { Skeletons = new[]{3}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{2}, Goatman = new[]{0}, SkeletonWar = new[]{2}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 5
    new WaveDefinition { Skeletons = new[]{3}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{3}, Goatman = new[]{0}, SkeletonWar = new[]{3}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 6
    new WaveDefinition { Skeletons = new[]{2}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{3}, Goatman = new[]{0}, SkeletonWar = new[]{3}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 7
    new WaveDefinition { Skeletons = new[]{2}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{4}, Goatman = new[]{0}, SkeletonWar = new[]{4}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 8
    new WaveDefinition { Skeletons = new[]{1}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{4}, Goatman = new[]{0}, SkeletonWar = new[]{4}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 9
    new WaveDefinition { Skeletons = new[]{1}, PsychoSkeletons = new[]{1}, ZombiePsycho = new[]{4}, Goatman = new[]{0}, SkeletonWar = new[]{5}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 10
    new WaveDefinition { Skeletons = new[]{0}, PsychoSkeletons = new[]{1}, ZombiePsycho = new[]{5}, Goatman = new[]{0}, SkeletonWar = new[]{5}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
      });

            WaveSystem.SetScene(SceneID.BWPScene5);
            WaveSystem.LoadWave(1);


            Console.WriteLine("[SpectralXEngine] Skeleton spawned from menu");
            Console.WriteLine("[InitScene8] Scene8 ready");
        }
