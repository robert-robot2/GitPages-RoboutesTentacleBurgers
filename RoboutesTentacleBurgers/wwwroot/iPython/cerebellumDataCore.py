# ==========================================================
# cerebellumDataCore.py — Nova Adeptus Training Examples
# Mirrors NovaCerebellum.cs — owned by Python as of 2026-09-09
# Called by pyodideHelper.js → CerebellumBridge.getExamples()
# ==========================================================
...
"aave_greeting": [
    ...
    "how you doing nova",
    "how you living",
    "why be you that way nova",
    "why you be like that",
    "why you gotta be like that",
    "why you acting brand new",
    "you a jive turkey nova",
    "jive turkey",
    "playa playa",
    "playa",
    "you a playa",
    "where you be had that nova",
    ...
    # add your categories here following the same pattern
}
