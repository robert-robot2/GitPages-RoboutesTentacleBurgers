...
namespace SpectralXGLX.SpectralXComponent
{
    public partial class SpectralXEngine
    {
        public void InitScene11()
        {
            ...
            Weather.Init(Scene11, MeshLibrary, new Dictionary<WeatherParticleType, ParticleVolume>
    {
        ...
        "/iAssets/IceTile010.png",
            ...
            // ── BWPScene8 (Dark Forest) ──────────────────────────────────────────
            AddSignpost(Scene11, "Scene11_SignpostToForest6",
                GetTriggerPos(SceneID.BWPScene8, SceneID.BWPScene7));
            AddSignpost(Scene11, "Scene11_SignpostToSnowTown",
                GetTriggerPos(SceneID.BWPScene8, SceneID.BWPScene11));
            AddSignpost(Scene11, "Scene11_SignpostToGraveyard",
                GetTriggerPos(SceneID.BWPScene8, SceneID.BWPScene9));
            ...
            SpectralDynManager.SpawnAll(Scene11, MeshLibrary, spawnRadius: 60f, seed: 42);
            ...
            WaveSystem.RegisterSceneWaves(SceneID.BWPScene8, new WaveDefinition[]
            {
    // Wave 1
    new WaveDefinition { Skeletons = new[]{0}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{3}, Goatman = new[]{2}, SkeletonWar = new[]{2}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0}, OnWaveStart = () => Console.WriteLine("[Scene11] Wave 1 started!") },
    // Wave 2
    new WaveDefinition { Skeletons = new[]{1}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{3}, Goatman = new[]{3}, SkeletonWar = new[]{3}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 3
    new WaveDefinition { Skeletons = new[]{1}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{4}, Goatman = new[]{3}, SkeletonWar = new[]{3}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 4
    new WaveDefinition { Skeletons = new[]{1}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{4}, Goatman = new[]{4}, SkeletonWar = new[]{4}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 5
    new WaveDefinition { Skeletons = new[]{1}, PsychoSkeletons = new[]{3}, ZombiePsycho = new[]{5}, Goatman = new[]{4}, SkeletonWar = new[]{4}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 6
    new WaveDefinition { Skeletons = new[]{0}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{5}, Goatman = new[]{5}, SkeletonWar = new[]{5}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 7
    new WaveDefinition { Skeletons = new[]{0}, PsychoSkeletons = new[]{2}, ZombiePsycho = new[]{5}, Goatman = new[]{5}, SkeletonWar = new[]{5}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 8
    new WaveDefinition { Skeletons = new[]{0}, PsychoSkeletons = new[]{1}, ZombiePsycho = new[]{6}, Goatman = new[]{6}, SkeletonWar = new[]{6}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 9
    new WaveDefinition { Skeletons = new[]{0}, PsychoSkeletons = new[]{0}, ZombiePsycho = new[]{6}, Goatman = new[]{6}, SkeletonWar = new[]{6}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
    // Wave 10
    new WaveDefinition { Skeletons = new[]{0}, PsychoSkeletons = new[]{0}, ZombiePsycho = new[]{7}, Goatman = new[]{7}, SkeletonWar = new[]{7}, ScavBoss = new[]{0}, SkeletonBoss = new[]{0} },
            });
            WaveSystem.SetScene(SceneID.BWPScene8);
            WaveSystem.LoadWave(1);

            for (int i = 0; i < 3; i++)
            {
                var (cx, cy) = RandomScatterPoint(0f, 0f, 12f);
                Cows.Add(SpawnCow(Scene11, cx, cy, 1.0f));
            }
            for (int i = 0; i < 3; i++)
            {
                var (catx, caty) = RandomScatterPoint(0f, 0f, 12f);
                Cats.Add(SpawnCat(Scene11, catx, caty, 1.0f));
            }
         

            Console.WriteLine("[SpectralXEngine] Skeleton spawned from menu");
            Console.WriteLine("[InitScene11] Scene11 ready");
        }
